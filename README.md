...
# 2 Ship 2 Harkinian for Nintendo Switch
...
#### Nintendo Switch
* Run one of the PC releases to generate an `mm.o2r` file. After launching the game on PC, you will be able to find these files in the same directory as `2ship.exe` or `2ship.appimage`.
